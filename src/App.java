...
import aeBusinessLogic.aeEntities.aeHLarva;
import aeBusinessLogic.aeEntities.aeHormiga;
import aeDataAccess.aeDAOs.aeAntCiberDronDAO;
...
public class App {
    public static void main(String[] args)   {
        ...
        try{
            ...
            aeHLarva l = new aeHLarva();
            System.out.println( l.getLava(1).toString() );

            aeHormiga h = l.aeComer("hierba");
        ...
        try{
            ...
            aeAntCiberDronDAO dao = new aeAntCiberDronDAO();

            for ( int i = 1 ; i <= dao.readAll().size() ; i++ ) {
                aeAntCiberDronDTO oDTO = dao.readBy(i);
                oDTO.setSerie("Serie-00" + i);
                dao.update(oDTO);
            }


            aeAntCiberDronDTO oDTO = dao.readBy(2);
            oDTO.setSerie("Serie02");
            dao.update(oDTO);
